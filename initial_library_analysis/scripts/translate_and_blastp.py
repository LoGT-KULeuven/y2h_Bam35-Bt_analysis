...
blastp_cline = NcbiblastpCommandline(query=ffas_out,
                                     db=db,
                                     outfmt='"6 qacc sacc stitle qlen slen qstart qend length nident mismatch positive evalue sstrand"',
                                     max_target_seqs=1,
...
headers = "qacc\tsacc\tstitle\tqlen\tslen\tqstart\tqend\tlength\tnident\tmismatch\tpositive\tevalue\tsstrand\n"
